...
// Configuration - Only keep constants that don't need dataManager
const SOURCES = [
...
// ============================================================
// TEXT CLEANING FUNCTION (kept as is)
// ============================================================
...
// ============================================================
// AutoPoster Class - Using dataManager
// ============================================================
...
class AutoPoster {
  ...
  // ============================================================
  // DATA MANAGEMENT - Using dataManager
  // ============================================================
  ...
  // ============================================================
  // IMAGE EXTRACTION METHODS (kept as is)
  // ============================================================
  ...
  async manualPost(content, imageUrl = null) {
    ...
    if (job.isPosted) {
      ...
      return { success: true, message: 'Post published!', url: result.url };
    } else {
...
async initialize() {
  ...
  // DO NOT auto-start cron jobs here
  // The user must click "Start" to begin posting
  if (this.running) {
    console.log(`⚠️ Saved state is "Running", but auto-poster is paused.`);
    console.log(`🟡 Click 'Start' to begin auto-posting`);
    // Reset running state to false on initialization
    // This ensures the user must explicitly start it
    this.running = false;
