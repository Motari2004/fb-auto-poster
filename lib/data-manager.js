...
import { readBlob, writeBlob, deleteBlob, blobExists, getPublicBlobUrl } from './blob-storage.js';
import {
  USE_BLOB_STORAGE,
  DATA_DIR,
  POST_QUEUE_FILE,
...
class DataManager {
  constructor() {
    ...
    console.log(`📊 DataManager: ${this.useBlob ? 'Public Blob Storage' : 'Local Files'}`);
  }
  ...
  getMode() {
    return this.useBlob ? 'Public Blob Storage' : 'Local Files';
  }
}
